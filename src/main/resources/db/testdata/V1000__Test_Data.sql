...
-- (Subset for brevity in example, but using the full set from original data.sql)
INSERT INTO expenses (amount, description, date, group_id, payer_id, currency, is_paid)
VALUES (75.50, 'Grocery shopping', '2024-04-20 10:30:00', 1, 1, 'EUR', false),
